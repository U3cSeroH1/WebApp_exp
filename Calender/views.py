...
class WeekCalendar(mixins.WeekCalendarMixin, generic.TemplateView):
    """週間カレンダーを表示するビュー"""
    template_name = 'Calender/week.html'
...
class WeekWithScheduleCalendar(mixins.WeekWithScheduleMixin, generic.TemplateView):
    ...
    template_name = 'Calender/week_with_schedule.html'
    model = Schedule
    date_field = 'date'
...
class MonthWithScheduleCalendar(mixins.MonthWithScheduleMixin, generic.TemplateView):
    ...
    template_name = 'Calender/month_with_schedule.html'
    model = Schedule
    date_field = 'date'
...
class MyCalendar(mixins.MonthCalendarMixin, mixins.WeekWithScheduleMixin, generic.CreateView):
    ...
    template_name = 'Calender/mycalendar.html'
    model = Schedule
    date_field = 'date'
    ...
    def form_valid(self, form):
        ...
        schedule.date = date
        schedule.save()
        return redirect('Calender:mycalendar', year=date.year, month=date.month, day=date.day)


class MonthWithFormsCalendar(mixins.MonthWithFormsMixin, generic.View):
    """フォーム付きの月間カレンダーを表示するビュー"""
    template_name = 'Calender/month_with_forms.html'
    model = Schedule
    date_field = 'date'
    ...
    def post(self, request, **kwargs):
        ...
        if formset.is_valid():
            formset.save()
            return redirect('Calender:month_with_forms')
