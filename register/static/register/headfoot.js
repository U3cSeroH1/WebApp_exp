...
// Feature detects + browser sniffs  犂?_犂?
...
function createStore(reducer, preloadedState, enhancer) {
   ...
   *
   * @param {Object} action A plain object representing 窶忤hat changed窶?. It is
...
Webflow.define('forms', module.exports = function ($, _) {
  ...
  function getStatus(field, type, name, value) {
    ...
    if (type === 'password') {
      ...
      status = 'Please confirm you窶决e not a robot.';
    }
...
function assertReducerSanity(reducers) {
  Object.keys(reducers).forEach(function (key) {
    ...
    if (typeof reducer(undefined, { type: type }) === 'undefined') {
      throw new Error('Reducer "' + key + '" returned undefined when probed with a random type. ' + ('Don\'t try to handle ' + __WEBPACK_IMPORTED_MODULE_0__createStore__["a" /* ActionTypes */].INIT + ' or other actions in "redux/*" ') + 'd. They are considered private. Instead, you must return the ' + 'current state for any unknown actions, unless it is undefined, ' + 'in which case you must return the initial state, regardless of the ' + 'action type. The initial state may not be undefined.');
    }
  });
}
 ...
 * by Gaﾃｫtan Renaudeau 2014 - 2015 窶? MIT License
 */
...
Webflow.define('scroll', module.exports = function ($) {
  ...
  function ready() {
    ...
    $doc.on('click', 'a', function (e) {
      ...
      // with the document窶冱 location to only target links on this page.
...
Webflow.define('touch', module.exports = function ($) {
  ...
  function Touch(el) {
    ...
    function start(evt) {
      // We don窶冲 handle multi-touch events yet.
...
Webflow.require('ix').init([
  {"slug":"defolte-lg","name":"defolte lg","value":{"style":{"display":"none","opacity":0},"triggers":[]}},
  {"slug":"pop-log","name":"pop log","value":{"style":{},"triggers":[{"type":"click","selector":".modal-wrapper","stepsA":[{"display":"block"},{"opacity":1,"transition":"opacity 200 ease 0"}],"stepsB":[]}]}},
  {"slug":"delete-lg","name":"delete lg","value":{"style":{},"triggers":[{"type":"click","selector":".modal-wrapper","stepsA":[{"opacity":0,"transition":"opacity 200 ease 0"},{"display":"none"}],"stepsB":[]}]}}
]);
/**
 * ----------------------------------------------------------------------
...
{"events":{"e-28":{"id":"e-28","eventTypeId":"PAGE_SCROLL_DOWN","action":{"id":"","actionTypeId":"GENERAL_START_ACTION","config":{"delay":0,"easing":"","duration":0,"actionListId":"a","affectedElements":{},"playInReverse":false,"autoStopEventId":"e-27"}},"mediaQueries":["main","medium","small","tiny"],"target":{"appliesTo":"PAGE","styleBlockIds":[],"id":"5bcaf1ee76071d016a1178cb"},"config":{"loop":false,"scrollOffsetValue":0,"scrollOffsetUnit":"%","delay":null,"direction":null,"effectIn":null},"createdOn":1548433332179},"e-29":{"id":"e-29","eventTypeId":"PAGE_SCROLL_UP","action":{"id":"","actionTypeId":"GENERAL_START_ACTION","config":{"delay":0,"easing":"","duration":0,"actionListId":"a-2","affectedElements":{},"playInReverse":false,"autoStopEventId":"e-30"}},"mediaQueries":["main","medium","small","tiny"],"target":{"appliesTo":"PAGE","styleBlockIds":[],"id":"5bcaf1ee76071d016a1178cb"},"config":{"loop":false,"scrollOffsetValue":0,"scrollOffsetUnit":"%","delay":null,"direction":null,"effectIn":null},"createdOn":1548433575636}},"actionLists":{"a":{"id":"a","title":"arema","actionItemGroups":[{"actionItems":[{"id":"a-n","actionTypeId":"TRANSFORM_MOVE","config":{"delay":0,"easing":"outQuad","duration":500,"target":{"id":"5bcaf1ee76071d016a1178cb|6db55dac-f1ef-d8f8-2188-ed9501c47813"},"yValue":-65,"xUnit":"PX","yUnit":"PX","zUnit":"PX"}}]}],"createdOn":1548433387906,"useFirstGroupAsInitialState":false},"a-2":{"id":"a-2","title":"nande","actionItemGroups":[{"actionItems":[{"id":"a-2-n","actionTypeId":"TRANSFORM_MOVE","config":{"delay":0,"easing":"outQuad","duration":500,"target":{"id":"5bcaf1ee76071d016a1178cb|6db55dac-f1ef-d8f8-2188-ed9501c47813"},"yValue":0,"xUnit":"PX","yUnit":"PX","zUnit":"PX"}}]}],"createdOn":1548433583733,"useFirstGroupAsInitialState":false}},"site":{"mediaQueries":[{"key":"main","min":992,"max":10000},{"key":"medium","min":768,"max":991},{"key":"small","min":480,"max":767},{"key":"tiny","min":0,"max":479}]}}
);